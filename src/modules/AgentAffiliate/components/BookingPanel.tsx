    ...
    return (
        <div className="bg-white dark:bg-gray-950 rounded-[1.5rem] border border-gray-100 dark:border-gray-800/50 overflow-hidden ring-1 ring-black/5">
            <div className="p-4 border-b border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/20">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 mb-0.5">Starting at</p>
                <div className="flex items-baseline gap-1">
                    <span className="text-xs font-bold text-gray-500">Rs.</span>
                    <span className="text-2xl font-bold text-gray-950 dark:text-white tracking-tighter">
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Travelers</label>
                    {product.pricing.map(option => (
                        <div key={option.type} className="flex justify-between items-center p-2.5 bg-gray-50/50 dark:bg-gray-900/30 rounded-xl border border-transparent active:scale-[0.98] transition-all">
                            <div>
                                <p className="font-bold text-gray-950 dark:text-white text-[10px] tracking-tight">{option.type}</p>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Rs. {option.cost.toLocaleString()}</p>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="w-4 text-center text-sm font-bold text-gray-950 dark:text-white">{travelerCounts[option.type]}</span>
                                <button
                                    onClick={() => handleTravelerChange(option.type, 1)}
                ...
                <div className="pt-3 border-t border-gray-100 dark:border-gray-800/50">
                    <div className="flex items-center gap-3 p-2 bg-teal-50/20 dark:bg-teal-900/10 rounded-xl border border-teal-100/30">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Expert Agent</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-3 border-t border-gray-100 dark:border-gray-800 flex justify-between items-end">
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Total Price</p>
                        <p className="font-bold text-lg text-gray-950 dark:text-white tracking-tighter">
                            <span className="text-[10px] font-bold text-gray-400 mr-0.5">Rs.</span>
                            {totalAmount.toLocaleString()}
                        </p>
                    </div>
                    <div className="text-[10px] font-bold text-teal-600 bg-teal-50 dark:bg-teal-900/20 px-1.5 py-0.5 rounded-md">
                        {totalTravelers} PAX
                    </div>
                </div>
            </div>
